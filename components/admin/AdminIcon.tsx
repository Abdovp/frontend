...
const paths: Record<AdminIconName, ReactElement> = {
  ...
  truck: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10m10 0h4m-4 0a2 2 0 104 0m-4 0a2 2 0 11-4 0m6 0a2 2 0 104 0m0 0V9a1 1 0 011-1h2.586a1 1 0 01.707.293l2.414 2.414a1 1 0 01.293.707V16"
    />
  ),
  refresh: (
    <path
