      ...
      <div className="container-wide relative">
        ...
        <div dir="rtl" className="grid gap-5 md:grid-cols-3 md:gap-6">
          {howToUse.steps.map((step, i) => (
            <div
              key={step.title}
              className="relative rounded-2xl border border-[#E5E7EB] bg-[#FFFFFF] p-6 text-right transition-colors hover:border-[#1A73E8]/35"
            >
              <span className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-[#1A73E8] text-lg font-extrabold text-white shadow-lg shadow-[#1A73E8]/30">
                {i + 1}
              </span>
