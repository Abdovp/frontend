...
const problems = [
  'منتجات رخيصة كتخسّرك الفلوس والوقت',
  'صعوبة إيجاد منتجات ذات جودة وأسعار معقولة',
    ...
    <section className="section-padding bg-white">
      <div className="container-wide max-w-3xl" dir="rtl">
        <SectionHeading
          ...
          title="كل زبون مغربي كيعاني من نفس المشاكل ف التسوق اليومي"
          subtitle="بويا شوب فهمات التحديات والقلق من المنتجات المغشوشة. لهذا كنوفرو منتجات مختارة كتحل المشكل فعلاً — ماشي كلام فالهضرة."
          align="center"
        />
