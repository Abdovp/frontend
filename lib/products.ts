...
export const products: Record<ProductId, Product> = {
  ...
  'car-vacuum': {
    ...
    stockLeft: 6,
    deliveryDays: 'الخميس أو الجمعة',
    checkoutHeadline: 'نظّف طوموبيلك ف دقائق — شفط، نفخ، وتنظيف عميق بجهاز وحدة',
    checkoutDescription:
      '3 وظائف ف جهاز وحدة: كتشفط التراب والفتات، كتنفخ باش تنظف الزوايا، وعندها 6 رؤوس قابلة للتبديل لكل الأماكن. شحن USB مريح — خذها ف أي مكان.',
    highlights: [
    ...
    pain: {
      eyebrow: 'المشكل',
      title: 'التراب والفتات يتراكمو — والتنظيف اليدوي ما يوصلش للزوايا',
      body: 'المقاعد، السجادة، الزوايا، والشقوق — أماكن صعبة توصلها بالخرقة. والمكانس الكبيرة ما تدخلش لطوموبيل.',
      bullets: [
        'التراب يتراكم ف الزوايا والشقوق الضيقة',
        'المكانس العادية كبيرة وما تناسبش السيارة',
        'الشفط اليدوي بطيء وما يعطيش نتيجة حقيقية',
      ],
    ...
    logic: {
      ...
      body: 'المكنسة كتشفط بقوة، كتنفخ للزوايا الضيقة، وعندها رؤوس متخصصة لكل سطح. شحن USB يعني دائماً جاهزة.',
      bullets: [
        'رأس خاص للسجادة، وآخر للشقوق، وآخر للأسطح العريضة',
        'وضع النفخ لتنظيف التهوية والزوايا الصعبة',
        'خفيفة وسهلة الحمل — تخزنها ف الطوموبيل',
      ],
