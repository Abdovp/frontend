...
export const products: Record<ProductId, Product> = {
  ...
  'car-vacuum': {
    ...
    metaDescription:
      'مكنسة سيارة 3 في 1 من بويا شوب: تشفط، تنفخ، وتنظف بعمق. 6 رؤوس قابلة للتبديل، شحن USB. دفع عند الاستلام، ضمان 30 يوم. من 149 درهم.',
    rating: 4.7,
    reviewCount: 310,
    unit: 'مكنسة',
    ...
    offers: [
      ...
      },
      {
        ...
        sublabel: 'وحدة ليك ووحدة هدية',
        badge: 'الأكثر مبيعاً',
        perks: ['جوج مكانس كاملة', 'توفير 129 درهم', 'توصيل مجاني', `ضمان ${WARRANTY_DAYS} يوم`],
      },
      {
        quantity: 3,
        price: 389,
        ...
        badge: 'أقصى توفير',
        perks: ['3 مكانس كاملة', 'توفير 178 درهم', 'توصيل مجاني', `ضمان ${WARRANTY_DAYS} يوم`],
      },
    ],
