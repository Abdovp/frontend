...
export const products: Record<ProductId, Product> = {
  'cooling-pack': {
    ...
    pain: {
      eyebrow: 'المشكل',
      title: 'كتفتح الباب وكتضربك السخونية لوجهك — كل يوم نفس العذاب',
      body: 'تخيّل: راجع من الخدمة، متعبان، تفتح باب الطوموبيل وكأنك فتحت فرن. الدركسيون يحرق يديك، الريحة تخنق، والعرق يبدا. المكيف يخدم بقوة لكن البنزين يروح والجلد يتشقق. كل صيف نفس القصة — وعلاش؟',
      bullets: [
        'الحرارة كتضرب وجهك من أول ما تفتح الباب',
        'الدركسيون يحرق يديك قبل ما تسوق',
        'الجلد والبلاستيك يتلفو بصمت ف كل صيف',
        'المكيف وحدو ما كافيش — والبنزين يروح',
      ],
  ...
  'magnetic-holder': {
    ...
    checkoutDescription:
      'مغناطيس قوي يمسك التلفون ف أي وضعية. تركيب ف 30 ثانية بلا أدوات.',
    highlights: [
    ...
    pain: {
      eyebrow: 'المشكل',
      title: 'لحظة واحدة ديال الشرود كافية — وكلنا عارفين هاد الإحساس',
      body: 'كنت ماشي ف الطريق، التلفون طاح من الحامل، حاولت تمسكو، فرملتي فجأة. هاد اللحظة كيعيشها بزاف ديال السائقين ف المغرب كل يوم. الحامل الرخيص ما كيأمنش — كيطيح ف المطب، كيتقطع فيه GPS ف أسوأ لحظة، وكيتلف من سخونة الصيف.',
      bullets: [
        'التلفون كيطيح ف كل فرملة أو مطب',
        'GPS كيتقطع ف اللحظة اللي محتاجو أكثر',
        'الشاشة فيها خدوش من كثرة ما طاح',
        'حاملات رخيصة كتتلف من الحرارة ف الصيف',
      ],
