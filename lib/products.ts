...
export const products: Record<ProductId, Product> = {
  'cooling-pack': {
    ...
    checkoutDescription:
      'مروحة + مظلة حرارية. تركّب ف دقيقة وتحس الفرق من أول استعمال. الدفع عند الاستلام — بلا مخاطرة.',
    highlights: [
      'حرارة الداخل كتهبط بشكل ملموس ف دقائق',
      'تركيب ف أقل من دقيقة — بلا ورشة',
      'حماية الجلد والبلاستيك من التشقق',
      'مروحة مزدوجة + مظلة حرارية ف باك وحدة',
      'دفع عند الاستلام — بلا مخاطرة',
    ],
    valueProps: [
    ...
    pain: {
      ...
      body: 'تركب، يحرق يديك الدركسيون، الريحة تخنق، والبلاستيك يتشقق. المكيف يخدم بقوة ويزيد ف البنزين. هاد المشكل راك تعيشو كل يوم.',
      bullets: [
        'حرارة خانقة من أول ما تفتح الباب',
        'الدركسيون والجلد يتلفو من الشمس',
        'المكيف وحدو ما كافيش',
      ],
    ...
    logic: {
      ...
      body: 'المروحة كتطرد الهواء السخون. المظلة كتحجب الشمس قبل ما تدخل. بجوج كيشتغلو مع بعض — نتيجة فورية بدون تعقيد.',
      bullets: [
        'فرق ملموس ف الحرارة من أول استعمال',
        'حماية الجلد والبلاستيك من التشقق',
        'بنزين أقل مع مكيف خفيف الشغل',
      ],
  ...
  'magnetic-holder': {
    ...
    checkoutDescription:
      'مغناطيس قوي يمسك التلفون ف أي وضعية. تركيب ف 30 ثانية بلا أدوات. الدفع عند الاستلام — بلا مخاطرة.',
    highlights: [
      'ثبات تام حتى ف الطرق الوعرة والمطبات',
      'تركيب وإزالة ف ثواني بلا أثر',
      'متوافق مع جميع التلفونات الكبيرة والصغيرة',
      'مغناطيس قوي — تلفونك ما يتحركش حتى ف الطريق الوعر',
      'دفع عند الاستلام — بلا مخاطرة',
    ],
    valueProps: [
    ...
    pain: {
      ...
      body: 'حامل ضعيف معناه خطر حقيقي. تلفون يهتز ويطيح، GPS كيتقطع ف اللحظة اللي محتاجو، ومكالمة فاتتك. والحاملات الرخيصة كتطيح من الحرارة ف الصيف.',
      bullets: [
        'التلفون كيطيح ف كل فرملة',
        'GPS كيتقطع ف أسوأ وقت',
        'حاملات رخيصة ما تتحملش الحرارة',
      ],
    ...
    logic: {
      ...
      body: 'نقرة وحدة وتلفونك ثابت. مغناطيس قوي يمسكو حتى ف الطرق الوعرة. تركيب ف 30 ثانية، ما يخلّيش أثر.',
      bullets: [
  ...
  'car-vacuum': {
    ...
    checkoutDescription:
      'شفط + نفخ + 6 رؤوس لكل زاوية. خفيفة، شحن USB، تخزّنها ف الطوموبيل دايماً. الدفع عند الاستلام — بلا مخاطرة.',
    highlights: [
    ...
    pain: {
      ...
      body: 'التراب والفتات يتراكمو ف أماكن ما توصلهاش. والمكانس الكبيرة ما تدخلش للسيارة. نتيجة: طوموبيل دايماً وسخة حتى بعد التنظيف.',
      bullets: [
        'التراب يتراكم ف الزوايا والشقوق',
        'المكانس الكبيرة ما تناسبش السيارة',
        'التنظيف اليدوي بطيء وما يعطيش نتيجة',
      ],
