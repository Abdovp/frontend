...
export const products: Record<ProductId, Product> = {
  ...
  'garden-sprinkler': {
    ...
    metaDescription:
      'رشاش الحديقة الذكي من بويا شوب: ريّ دقيق ومرن مع تغطية واسعة. دفع عند الاستلام، ضمان 30 يوم، توصيل سريع. من 149 درهم.',
    rating: 4.8,
    reviewCount: 410,
    unit: 'رشاش',
    ...
    offers: [
      ...
      },
      {
        ...
        badge: 'الأكثر مبيعاً',
        perks: ['رشّان بصفقة ممتازة', 'توفير 69 درهم', 'توصيل مجاني', `ضمان ${WARRANTY_DAYS} يوم`],
      },
      {
        quantity: 3,
        price: 329,
        ...
        badge: 'أفضل قيمة',
        perks: ['3 رشاشات بأحسن ثمن', 'توفير 118 درهم', 'توصيل مجاني', `ضمان ${WARRANTY_DAYS} يوم`],
      },
    ],
