...
export const products: Record<ProductId, Product> = {
  'cooling-pack': {
    ...
    checkoutDescription: 'تركّيب ف دقيقة وتحس بالفرق من أول استعمال.',
    highlights: [
    ...
    pain: {
      ...
      body: 'تخيّل: تبغي تخرج فالطوموبيل، تحل الباب وضربك السخونية فحال الفران. الغيدون يحرق يديك، الريحة تخنق، والعرق خانز. المكيف يخدم بقوة لكن يتعطل باش يبرد. كل صيف نفس القصة — وعلاش؟',
      bullets: [
        'السخونية كتضرب وجهك من أول ما تحل الباب',
        'الغيدون يحرق يديك قبل ما تسوق',
    ...
    logic: {
      ...
      body: 'المروحة كتطرد الهواء السخون. المظلة كتحجب الشمس قبل ما تدخل. بجوج كيخدمو مع بعضياتهم — نتيجة فورية بدون تعقيد.',
      bullets: [
