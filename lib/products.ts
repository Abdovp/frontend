...
export const products: Record<ProductId, Product> = {
  ...
  'car-vacuum': {
    ...
    metaDescription:
      'مكنسة سيارة 3 في 1 من بويا شوب: تشفط، تنفخ، وتنظف بعمق. 6 رؤوس قابلة للتبديل، شحن USB. دفع عند الاستلام، ضمان 30 يوم. من 99 درهم.',
    rating: 4.7,
    reviewCount: 310,
    unit: 'مكنسة',
    ...
    offers: [
      ...
      },
      {
        ...
        sublabel: 'وحدة ليك ووحدة هدية',
        badge: 'الأكثر مبيعاً',
        perks: ['جوج مكانس كاملة', 'توفير 28 درهم', 'توصيل مجاني', `ضمان ${WARRANTY_DAYS} يوم`],
      },
      {
        quantity: 3,
        price: 249,
        ...
        badge: 'أقصى توفير',
        perks: ['3 مكانس كاملة', 'توفير 48 درهم', 'توصيل مجاني', `ضمان ${WARRANTY_DAYS} يوم`],
      },
    ],
