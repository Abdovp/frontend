  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="تعرّف على قصة بويا شوب، رسالتنا وقيمنا ف عالم المنتجات المبتكرة بالمغرب." />
      </Head>
      <Header />
      <main>
        <section className="bg-brand text-white relative overflow-hidden">
          ...
          <div className="relative container-wide py-16 md:py-24 max-w-3xl">
            ...
            <p className="text-white/75 text-lg leading-relaxed">
              بدينا بفكرة بسيطة: نوفرو لكل زبون مغربي منتجات عملية ومبتكرة بجودة عالية وثمن عادل، بلا
        ...
        <section className="section-padding bg-white">
          <div className="container-wide max-w-3xl">
            ...
            <p className="text-ink text-lg leading-relaxed mb-5">
              كنّا نشوفو الزبناء كيعانيو من نفس المشاكل، والحلول إما غالية بزاف ولا مقلدة. قررنا
              نغيّرو هاد الواقع: كل زبون مغربي يستاهل منتجات أصلية، أسعار شفافة، وخدمة كتحترمو.
            </p>
