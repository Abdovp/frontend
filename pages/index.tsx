...
export default function Home() {
  return (
    <>
      <Head>
        <title>بويا شوب | متجر مغربي للمنتجات المبتكرة — Boya Shop</title>
        <meta
          name="description"
          content="بويا شوب: متجر DTC مغربي متخصص في المنتجات المبتكرة والعملية. كتالوج متنامِ، دفع عند الاستلام، ضمان 30 يوم، توصيل سريع."
        />
      </Head>
      <Header />
      <main>
